...
export default function OpeningHoursModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} modal>
      <DialogContent
        className="max-h-[95vh] w-[calc(100vw-2rem)] max-w-[760px] overflow-y-auto overflow-x-hidden rounded-[20px] bg-[#F5F5F5] p-4 sm:p-6"
                  ...
                  >
                    ...
                    {!day.isClosed ? (
                      <div className="mt-4 space-y-4">
                        ...
                        <div className="min-w-0 overflow-hidden rounded-[12px] border border-dashed border-gray-200 bg-gray-50/70 p-3">
                          <div className="mb-3 flex min-w-0 flex-wrap items-center justify-between gap-3">
                            ...
                            <button
                              ...
                              className="inline-flex shrink-0 items-center gap-1 rounded-full border border-primary/20 bg-white px-3 py-1 text-xs font-medium text-primary transition hover:bg-primary/5"
                            >
                              <Plus size={13} />
                              Add break
                            </button>
                            ...
                            <div className="space-y-2">
                              {day.breakTimes.map((breakTime, breakIndex) => (
                                <div
                                  ...
                                  className="grid min-w-0 grid-cols-1 gap-2 rounded-[10px] border border-gray-100 bg-white p-3 sm:grid-cols-[minmax(0,0.85fr)_minmax(0,0.85fr)_minmax(0,2fr)_auto]"
                                >
                                  <input
                                    type="time"
                                  ...
                                  <button
                                    ...
                                    className="inline-flex h-10 shrink-0 items-center justify-center rounded-md border border-red-100 bg-red-50 px-3 text-red-600 transition hover:bg-red-100"
                    ...
                    <input
                      ...
                      className="mt-4 w-full min-w-0 rounded-md border px-3 py-2 text-sm"
                    />
                  </div>
                ))}
              </div>
          ...
          <section className="w-full min-w-0 overflow-hidden rounded-[16px] bg-white p-4 sm:p-5">
            <div className="mb-4 flex min-w-0 flex-wrap items-start justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex shrink-0 items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-2 text-sm font-medium text-primary transition hover:bg-primary/10"
              >
                <Plus size={15} />
                Add holiday range
              </button>
                  ...
                  >
                    <div className="mb-3 flex min-w-0 flex-wrap items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className="inline-flex h-9 items-center justify-center rounded-md border border-red-100 bg-red-50 px-3 text-sm text-red-600 transition hover:bg-red-100"
                      >
                        <Trash2 size={15} />
                      </button>
                    </div>
                    ...
                    <div className="grid min-w-0 grid-cols-1 gap-3 sm:grid-cols-2">
                      <label className="min-w-0 space-y-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateHolidayRange(index, "fromDate", e.target.value)
                          }
                          className="w-full min-w-0 rounded-md border px-3 py-2 text-sm"
                        />
                      </label>
                      ...
                      <div className="mt-3 grid min-w-0 grid-cols-1 gap-3 sm:grid-cols-2">
                        <label className="min-w-0 space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateHolidayRange(index, "openTime", e.target.value)
                            }
                            className="w-full min-w-0 rounded-md border px-3 py-2 text-sm"
                          />
                        </label>
                        ...
                        <label className="min-w-0 space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateHolidayRange(index, "closeTime", e.target.value)
                            }
                            className="w-full min-w-0 rounded-md border px-3 py-2 text-sm"
                          />
                        </label>
                    ...
                    <input
                      ...
                      className="mt-3 w-full min-w-0 rounded-md border bg-white px-3 py-2 text-sm"
                    />
                  </div>
                ))}
              </div>
