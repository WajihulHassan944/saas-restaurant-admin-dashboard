...
export default function ImportModal({
  open,
  onOpenChange,
  title = "Import Branch List", // ✅ fallback
  subtitle = "Import Branch list for this restaurant", // ✅ fallback
}: ImportModalProps) {
  ...
  const handleDownload = () => {
    ...
    link.href = "/path-to-empty-file.xlsx";
    link.download = "Empty_File.xlsx";
    link.click();
  };
      ...
      <DialogContent className="max-w-[420px] rounded-[20px] p-7 bg-[#F5F5F5] max-h-[95vh] overflow-auto">
        ...
        <div className="mt-4 rounded-[16px] bg-white p-6">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            >
              <img src="/excel.png" alt="Excel" className="w-[64px] h-[64px]" />
            </div>
